...
{{
var G__26813 = cljs.core.pop.call(null,v__$1);
v__$1 = G__26813;
continue;
}
} else
...
{var pred__26817 = cljs.core._EQ_;var expr__26818 = limit;if(cljs.core.truth_(pred__26817.call(null,1,expr__26818)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__26817.call(null,2,expr__26818)))
...
var G__26820 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__26821 = (limit__$1 - 1);
var G__26822 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__26820;
limit__$1 = G__26821;
parts = G__26822;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___26824 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___26824))
{var replacement_26825 = temp__4090__auto___26824;buffer.append([cljs.core.str(replacement_26825)].join(''));
} else
{buffer.append(ch);
}
{
var G__26826 = (index + 1);
index = G__26826;
continue;
}
}
